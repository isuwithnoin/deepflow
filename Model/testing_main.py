...
from generator_for_test import TrafficGenerator
from model import TestModel
from visualization import Visualization
from utils import import_test_configuration, set_sumo_for_test, set_test_path


if __name__ == "__main__":

    config = import_test_configuration(config_file='testing_settings.ini')
    sumo_cmd = set_sumo_for_test(config['gui'], config['sumocfg_file_name'], config['max_steps'])
